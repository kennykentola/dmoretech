    ...
    // Admin Credentials (Note: Hardcoded for demo; use secure storage in production)
...
const products = [
    ...
    },
    {
        ...
        description: 'A stylish and efficient oven, crafted with premium materials for all your cooking needs.'
    },
    {
        id: 'airblower',
        name: 'Air Blower',
        ...
        description: 'A powerful air blower designed for efficient cleaning and maintenance tasks.'
    },
    {
        id: 'microwave',
        name: 'Microwave',
        ...
        description: 'A durable and user-friendly microwave for quick and convenient meal preparation.'
    },
    {
        id: 'hometheater',
        name: 'Home Theater',
        ...
        description: 'A high-quality home theater system delivering immersive sound for your entertainment.'
    },
    {
        id: 'iron',
        name: 'Pressing Iron',
        ...
        description: 'A high-quality pressing iron for crisp and wrinkle-free clothing.'
    },
    {
        id: 'solarproduct',
        name: 'Solar Product',
        ...
        description: 'A reliable solar product for sustainable energy solutions.'
    },
    {
        id: 'iron2',
        name: 'Pressing Iron',
        ...
        description: 'A premium pressing iron for professional-quality ironing.'
    },
    {
        id: 'ceilingfan',
        name: 'Ceiling Fan',
        ...
        description: 'A high-quality ceiling fan to keep your home cool and comfortable.'
    },
    {
        id: 'washingmachine',
        ...
        description: 'A durable washing machine for efficient and long-lasting laundry care.'
    },
    {
        id: 'fridge1',
        name: 'Fridge',
        ...
        description: 'A compact fridge to keep your food and beverages fresh and cool.'
    },
    {
        id: 'fridge2',
        name: 'Fridge',
        ...
        description: 'A spacious fridge for efficient cooling and storage of food and drinks.'
    }
];
...
$(document).ready(function () {
    ...
    // Initialize phone input with better error handling
    function initializePhoneInput() {
        if ($("#customer-phone").length) {
            try {
                ...
                // Fallback to regular input if plugin fails
                $("#customer-phone").attr("type", "tel");
            }
        }
    }
    ...
    $("#contact-form").off("submit").on("submit", function (event) {
        event.preventDefault();
        event.stopImmediatePropagation(); // Prevent multiple handlers
        ...
        submitButton.prop('disabled', true); // Disable button to prevent double-clicks
        isSubmitting = true;
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log('Formspree submission successful:', response);
                alert('Message sent successfully! Check your email (including spam/junk) for confirmation.');
                $("#contact-form")[0].reset();
                enhanceAdminDashboard(); // Refresh dashboard to show new message
            },
            error: function (xhr, status, error) {
                console.error('Formspree submission failed:', { status, error, xhr });
                alert('Error sending message. It has been saved locally and can be viewed in the admin dashboard. Please try again later.');
            },
            complete: function () {
                submitButton.prop('disabled', false);
                isSubmitting = false;
